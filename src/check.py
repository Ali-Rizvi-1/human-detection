...
#     self.image_sub = rospy.Subscriber("/camera/infra1/image_raw",Image,self.callback)
...
#     print(max(cv_image), min(cv_image))
...
# def main(args):
#   ic = image_converter()
#   rospy.init_node('image_converter_infra', anonymous=True)
#   try:
#     rospy.spin()
...
# # f = open(r"/home/ali/catkin_ws/src/human-detection/src/pose_slam.txt", "w+")
...
drone_slam_pose = open(r"/home/ali/catkin_ws/src/human-detection/src/test.txt", "a")
# drone_slam_pose.write([x1,y1,z1])
for i in range(5):
  simplejson.dump([i,i+1], drone_slam_pose)
